...
#3. For each transaction in TX, find the previous datetime when wallet balance went below 20 credits. The most recent time in the past should be considered. 
#Call this field previous_expiry.
...
op=op[['broker_id','transaction_time','account_credits','previous_expiry','next_expiry']]
